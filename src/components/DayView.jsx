    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative bg-white dark:bg-dark-surface w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-2xl shadow-2xl z-10 font-sans"
            >
                {/* Header Section */}
                <div className={`relative p-8 text-white bg-gradient-to-r from-gray-800 to-gray-900 dark:from-dark-base dark:to-dark-surface border-b-4 border-${dayData.color}`}>
                    <button
                        onClick={onClose}
                ...
                <div className="p-8 space-y-8">
                    ...
                    {/* Partner Info */}
                    <div className="bg-gray-50 dark:bg-dark-elevated/50 p-6 rounded-xl border border-gray-100 dark:border-dark-border flex items-start gap-4">
                        <div className="p-3 bg-white dark:bg-dark-surface rounded-lg shadow-sm text-gray-700 dark:text-gray-200">
                            <User size={24} />
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <div className="relative pl-4 border-l-2 border-gray-200 dark:border-dark-border space-y-8">
                            {dayData.activities.map((act, idx) => (
                                <div key={idx} className="relative pl-6">
                                    {/* Timeline dot */}
                                    <span className="absolute -left-[9px] top-1.5 w-4 h-4 rounded-full bg-white dark:bg-dark-surface border-4 border-gray-300 dark:border-dark-border"></span>

                                    <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1">
                                        <h4 className="font-bold text-gray-800 dark:text-white text-lg">{act.title}</h4>
                                        <span className="text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-dark-elevated px-2 py-1 rounded">
                                            {act.time}
                                        </span>
                                    </div>
                ...
                {/* Footer */}
                <div className="p-6 border-t dark:border-dark-border bg-gray-50 dark:bg-dark-base flex justify-end">
                    <button
                        onClick={onClose}
                        className="px-6 py-2.5 bg-gray-900 hover:bg-gray-800 dark:bg-dark-elevated dark:hover:bg-dark-surface text-white font-medium rounded-lg transition-colors shadow-lg hover:shadow-xl"
                    >
                        Close Dashboard
                    </button>
                </div>
