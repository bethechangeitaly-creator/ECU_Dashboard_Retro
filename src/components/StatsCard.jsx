...
const StatsCard = ({ title, value, icon: Icon, color, trend, subtitle }) => {
    ...
    return (
        <div className="bg-retro-white p-4 xs:p-5 md:p-6 border-4 border-retro-gray shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-0 h-full">
            ...
            <div>
                ...
                <h4 className="text-sm xs:text-base sm:text-lg md:text-xl xl:text-2xl font-bold font-pixel-header text-black break-words leading-none whitespace-nowrap">{value}</h4>
                {subtitle && (
