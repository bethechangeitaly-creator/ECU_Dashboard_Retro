...
import { LayoutDashboard, Calendar, Users, FileText, BarChart3, Lightbulb, BookOpen, Rocket, Heart, X } from 'lucide-react';
...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <div className={`
                w-64 bg-white h-screen border-r border-gray-100 flex flex-col fixed left-0 top-0 z-50
                transform transition-transform duration-300 ease-in-out
                ${isOpen ? 'translate-x-0' : '-translate-x-full'}
                lg:translate-x-0
            `}>
                {/* Logo Area */}
                <div className="p-6 lg:p-8 flex items-center justify-between border-b border-gray-100">
